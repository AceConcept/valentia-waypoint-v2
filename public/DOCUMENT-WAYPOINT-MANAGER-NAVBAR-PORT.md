...
| **Asset** | `public/Union-2.svg` (plus icon; colored via CSS mask as `#d9d9d9`) |
...
Plus icon (24×24 viewBox). Icon color is applied in CSS — use mask + `background-color: #d9d9d9`:

```css
mask: url('/Union-2.svg') center / contain no-repeat;
```
...
4. Add `public/Union-2.svg` (plus icon in manager square).
